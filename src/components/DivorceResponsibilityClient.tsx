...
export default function DivorceResponsibilityClient({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Admin-only. Jamie never renders this, and neither does "View as Jamie". */}
      {admin && <SpendingHistory />}
...
// ── Spending history, 2017 to today (admin only) ─────────────────────────────
// The long view behind the bill above: every dollar Chris put out, cut on the
// real marriage and separation dates. Deliberately shows how solid each slice
// is right next to the total — the evidence is the story here, not the number.
